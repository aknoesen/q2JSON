...
class Q2JSONLaTeXProcessor:
    ...
    def render_latex_with_validation(self, text: str) -> Tuple[str, Dict[str, Any]]:
        ...
        if self.validator is None:
            self.validator = MathValidationManager(self)
        validation_issues = self.validator.validate_math_content(text)
        ...
        # Step 4: Create validation results dictionary
        validation_results = {
    ...
    def validate_math_content(self, text: str) -> Dict[str, Any]:
        ...
        """
        # Create a mock question to use our existing validation logic
        mock_question = {'question_text': text}
        return self.validate_question_math(mock_question)
